...
class ProfileSeleniumTestCase(TestCase):
    ...
    def test_chat_text(self):
        # try:
            ...
            browser.find_element_by_xpath("//input[@id='id_major']").clear()
            browser.find_element_by_xpath(
                "//input[@id='id_major']").send_keys("Computer Science")
            time.sleep(2)
            browser.find_element_by_xpath(
            ...
            # fill in registration form
            time.sleep(3)
            browser2.find_element_by_xpath("//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            # gender
            browser2.find_element_by_xpath("//div[@class='form-group question-body']/select[@id='id_gender']").click()
            browser2.find_element_by_xpath("//select[@id='id_gender']/option[text()='Other']").click()
            browser2.find_element_by_xpath("//div[@id='slide0']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            # class rank
            browser2.find_element_by_xpath("//select[@id='id_class_rank']/option[text()='Second Year']").click()
            time.sleep(1)
            browser2.find_element_by_xpath("//div[@id='slide1']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            browser2.find_element_by_xpath("//input[@id='id_major']").clear()
            browser2.find_element_by_xpath("//input[@id='id_major']").send_keys("Computer Science")
            time.sleep(2)
            browser2.find_element_by_xpath("//div[@id='slide2']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            browser2.find_element_by_xpath("//div[@id='slide3']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            browser2.find_element_by_xpath("//textarea[@id='id_description']").clear()
            browser2.find_element_by_xpath("//textarea[@id='id_description']").send_keys(
                "I am a computer science student.")
            time.sleep(1)
            browser2.find_element_by_xpath("//div[@id='slide4']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            browser2.find_element_by_xpath("//input[@id='id_roommates']").clear()
            browser2.find_element_by_xpath("//input[@id='id_roommates']").send_keys("2")
            time.sleep(2)
            browser2.find_element_by_xpath("//div[@id='slide5']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            browser2.find_element_by_xpath("//input[@id='id_semesters']").clear()
            browser2.find_element_by_xpath("//input[@id='id_semesters']").send_keys("1")
            time.sleep(2)
            browser2.find_element_by_xpath("//div[@id='slide6']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            browser2.find_element_by_xpath("//select[@id='id_politics']/option[text()='Moderate']").click()
            time.sleep(2)
            browser2.find_element_by_xpath("//div[@id='slide7']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            slider = browser2.find_element_by_xpath("//input[@id='id_social_factor']")
            move = ActionChains(browser2)
            time.sleep(2)
            move.click_and_hold(slider).move_by_offset(5, 0).release().perform()
            browser2.find_element_by_xpath("//div[@id='slide8']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            slider = browser2.find_element_by_xpath("//input[@id='id_tidiness_factor']")
            move = ActionChains(browser2)
            move.click_and_hold(slider).move_by_offset(10, 0).release().perform()
            browser2.find_element_by_xpath("//div[@id='slide9']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            slider = browser2.find_element_by_xpath("//input[@id='id_party_factor']")
            move = ActionChains(browser2)
            move.click_and_hold(slider).move_by_offset(10, 0).release().perform()
            browser2.find_element_by_xpath("//div[@id='slide10']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            slider = browser2.find_element_by_xpath("//input[@id='id_guest_factor']")
            move = ActionChains(browser2)
            move.click_and_hold(slider).move_by_offset(10, 0).release().perform()
            browser2.find_element_by_xpath("//div[@id='slide11']//button[contains(text(), 'Next')]").click()
            time.sleep(2)
            slider = browser2.find_element_by_xpath("//input[@id='id_min_match_percentage']")
            move = ActionChains(browser2)
            move.click_and_hold(slider).move_by_offset(10, 0).release().perform()
            browser2.find_element_by_xpath("//div[@id='slide12']//button[contains(text(), 'Register')]").click()
