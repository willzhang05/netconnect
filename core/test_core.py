...
class ProfileSeleniumTestCase(TestCase):
    ...
    def test_register_gmail(self):
        try:
            ...
            text = browser.find_element_by_xpath(
                "//div[@class='slides']/div[@id='slide-intro']/p").text
    ...
    def test_edit_profile(self):
        try:
            ...
            browser.find_element_by_xpath(
                "//div[@class='form-group'][15]/input[@id='id_guest_factor']").send_keys(Keys.BACKSPACE)
            # the default is not 5, so we are changing it from the original value
            browser.find_element_by_xpath(
                "//div[@class='form-group'][15]/input[@id='id_guest_factor']").send_keys("5")
            time.sleep(1)

            browser.find_element_by_xpath(
                "//div[@class='card']/form/button[@class='btn btn-outline-primary']").click()
            time.sleep(3)
            val1 = browser.find_element_by_xpath(
                "//div[@class='card']/table[@id='profile-fields']/tbody/tr[14]/td").text
            ...
            browser.find_element_by_xpath(
                "//div[@class='card']/form/button[@class='btn btn-outline-primary']").click()
            time.sleep(3)
            val2 = browser.find_element_by_xpath(
                "//div[@class='card']/table[@id='profile-fields']/tbody/tr[14]/td").text
            assert val1 != val2
        except WebDriverException:
            assert True
    ...
    def test_matching_when_turned_on(self):
        try:
            ...
            if(browser.find_element_by_xpath("//table[@id='profile-fields']/tbody/tr[16]/td").text == "False"):
                ...
                time.sleep(1)
                browser.find_element_by_xpath(
                    "//input[@id='id_match_enabled']").click()
                time.sleep(1)
                browser.find_element_by_xpath(
                    "//button[@class='btn btn-outline-primary']").click()
                time.sleep(1)
    ...
    def test_see_other_profile(self):
        try:
            ...
            my_profile_email = browser.find_element_by_xpath(
                "//table[@id='profile-fields']/tbody/tr[3]/td").text
            # check to see if match enabled (if it isn't, enable it)
            if(browser.find_element_by_xpath("//table[@id='profile-fields']/tbody/tr[16]/td").text == "False"):
                browser.find_element_by_xpath(
                    "//div[@id='profile-interactions']//a[@href='/profile/edit']").click()
            ...
            time.sleep(1)
            browser.find_element_by_id(
                "id_min_match_percentage").send_keys("1")
            browser.find_element_by_xpath(
                "//button[@class='btn btn-outline-primary']").click()
            time.sleep(1)
            ...
            time.sleep(1)
            browser.find_element_by_xpath(
                "//li[@class='list-group-item match-item'][1]/div[@class='match-info'][3]/a/button[@class='btn btn-outline-primary']").click()
            other_profile_email = browser.find_element_by_xpath(
                "//table[@id='profile-fields']/tbody/tr[3]/td").text
            print("my: " + str(my_profile_email) +
                  " them: " + str(other_profile_email))
    ...
    def test_wrong_chat_url(self):
        try:
            ...
            browser.get(
                "https://netconnect.herokuapp.com/chat/wam5pxw-testu2522")
    ...
    def test_full_register(self):
        try:
            ...
            time.sleep(3)
            browser.find_element_by_xpath(
                "//select[@id='id_major']/option[text()='Computer Science']").click()
            time.sleep(3)
            browser.find_element_by_xpath(
            ...
            real_values = ['Test', 'User', 'testu2522@gmail.com', 'Other', 'Second Year', 'Computer Science',
                           'I am a computer science student.', '3', '5', 'Moderate', '3', '3', '3', '3', '52.0', 'True']
            test_values = []  # we want to make sure that the values we get are the same as what exist
            for i in range(16):
                test_values.append(browser.find_element_by_xpath(
                    "//tbody/tr[{}]/td".format(i + 1)).text)
    ...
    def test_chat_text(self):
        try:
            ...
            browser2.find_element_by_xpath(
                "//div[@id='content']//a[@href='/login/google-oauth2/?next=/register/']").click()
            time.sleep(2)
            browser2.find_element_by_id(
                "identifierId").send_keys("tu380686@gmail.com")
            ...
            textbefore = browser2.find_element_by_xpath(
                "//div[@id='chat-messages']").text
            browser2.find_element_by_xpath(
                "//div[@class='form-group'][3]/input[@id='chat-message-input']").send_keys("hi this is a test")
            time.sleep(1)
            browser2.find_element_by_xpath(
                "//button[@id='chat-message-submit']").click()
            time.sleep(1)

            textafter = browser2.find_element_by_xpath(
                "//div[@id='chat-messages']").text
            ...
            testother = browser.find_element_by_xpath(
                "//div[@id='chat-messages']").text

            browser.find_element_by_xpath(
                "//button[@id='chat-message-submit']").click()
            textafter = browser.find_element_by_xpath(
                "//div[@id='chat-messages']").text
            ...
            print("user2_url == https://netconnect.herokuapp.com/chat/tu380686-testu2522/: ",
                  user2_url.contains("https://netconnect.herokuapp.com/chat/testu2522-tu380686/"))
            print("user1_url == https://netconnect.herokuapp.com/chat/testu2522-tu380686/: ",
                  user1_url.contains("https://netconnect.herokuapp.com/chat/tu380686-testu2522/"))

            assert (textbefore != textafter) and (textafter == testother) and (user2_url.contains(
                "https://netconnect.herokuapp.com/chat/testu2522-tu380686")) and (user1_url.contains("https://netconnect.herokuapp.com/chat/tu380686-testu2522"))
        except:
            assert True
