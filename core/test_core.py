...
class ProfileSeleniumTestCase(TestCase):
    ...
    #         textbefore = browser.find_element_by_xpath("//div[@id='chat-messages']").text
    #         browser.find_element_by_xpath("//div[@class='form-group'][3]/input[@id='chat-message-input']").send_keys("hi this is a test")
