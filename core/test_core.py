...
#             assert True
    ...
    #         real_values = ['Test', 'User', 'testu2522@gmail.com', 'Other', 'Second Year', 'Computer Science', 'I am a computer science student.', '3', '5', 'Moderate', '3', '3', '3', '3', '51.4', 'True']
    ...
    def test_chat_text(self):
        try:
            ...
            # check to see if match enabled (if it is not, enable it)
            if (browser2.find_element_by_xpath("//table[@id='profile-fields']/tbody/tr[16]/td").text == "True"):
                print("enter")
